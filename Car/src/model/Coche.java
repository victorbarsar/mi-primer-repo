...
public class Coche extends Vehiculo {
    ...
    // Constructor
    public Coche(String brand, String carplate, String model, int hp, int places, ColorEnum color, FuelType fuelType, String manufactureDate, int speed, int numDoors) {
    ...
    public static void main(String[] args) {
        ...
        Coche coche1 = new Coche("Toyota", "XYZ 1234", "Corolla", 150, 5, ColorEnum.BLUE, FuelType.GASOLINA, "15/03/2010", 0, 4);
