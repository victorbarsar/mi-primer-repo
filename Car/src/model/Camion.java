...
public class Camion extends Vehiculo {
    ...
    // Constructor
    public Camion(String brand, String carplate, String model, int hp, int places, ColorEnum color, FuelType fuelType, String manufactureDate, int speed, int numDoors) {
    ...
    public static void main(String[] args) {
        ...
        Camion camion1 = new Camion("Mercedes", "XYZ 1234", "Corolla", 150, 5, ColorEnum.BLUE, FuelType.GASOLINA, "15/03/2010", 0, 4);
